# Private Interview One-Pager — TEMPLATE

> **Copy this file to `PRIVATE_interview_onepager.md`** (or export a PDF) and fill in your REAL
> absolute numbers. That filled copy is **git-ignored** — it must never be committed. Keep it
> local and show it in interviews only. The public repo stays rates-only.
...
*Reminder: in public materials (GitHub, LinkedIn, resume) speak in rates and multiples. Absolute
counts stay on this page.*
